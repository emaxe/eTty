...
- **Автообнаружение** — Claude, Codex, Copilot, Cursor Agent, OpenCode
...
- **Режим Shift+Enter для каждого агента** — настройте поведение Shift+Enter для каждого ИИ-агента (протокол Kitty, перенос строки или Ctrl+J). Полезно для агентов, которые не поддерживают Kitty-последовательности (например, Qwen).
