...
- REQ-9a: Drop в корневую директорию — работает при наведении на заголовок корня или на пустую область дерева
- REQ-9b: Auto-scroll дерева при drag: автоматическая прокрутка вверх/вниз при приближении курсора к краю зоны (edge size ~24px, speed 6px/16ms)
